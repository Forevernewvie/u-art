  ...
  group('NotificationService', () {
    ...
    test('scheduleD1Notification does not crash with past date', () async {
      final detail = PerformanceDetail(
        id: '1', title: 'T', startDate: '2000.01.01', endDate: '2000.01.01',
    ...
    test('scheduleD1Notification schedules with future date', () async {
      final detail = PerformanceDetail(
        id: '1', title: 'T', startDate: '2099.12.31', endDate: '2099.12.31',
        venue: 'V', cast: 'C', runtime: 'R', timeGuidance: 'TG', ageLimit: 'A', price: 'P',
        posterUrl: 'P', genre: 'G', state: '공연예정', district: '전체', bookingLinks: [], detailImages: []
      );
    ...
    test('scheduleD1Notification handles exceptions gracefully', () async {
      final detail = PerformanceDetail(
        id: '1', title: 'T', startDate: 'invalid_date', endDate: '2099.12.31',
        venue: 'V', cast: 'C', runtime: 'R', timeGuidance: 'TG', ageLimit: 'A', price: 'P',
        posterUrl: 'P', genre: 'G', state: '공연예정', district: '전체', bookingLinks: [], detailImages: []
      );
    ...
    test('scheduleTicketOpenNotification does not crash', () async {
      final detail = PerformanceDetail(
        id: '1', title: 'T', startDate: '2099.01.01', endDate: '2099.01.01',
        venue: 'V', cast: 'C', runtime: 'R', timeGuidance: 'TG', ageLimit: 'A', price: 'P',
        posterUrl: 'P', genre: 'G', state: '공연예정', district: '전체', bookingLinks: [], detailImages: []
      );
