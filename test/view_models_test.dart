...
void main() {
  group('ViewModels', () {
    ...
    setUp(() async {
      ...
      SharedPreferences.setMockInitialValues({'bookmarked_performances': ['1']});
    ...
    test('BookmarkNotifier toggles bookmark', () async {
      ...
      final detail2 = PerformanceDetail(
        id: '2', title: 'T2', startDate: '2026.01.01', endDate: '2026.12.31',
        venue: 'V', cast: 'C', runtime: 'R', timeGuidance: 'TG', ageLimit: 'A', price: 'P',
        posterUrl: 'P', genre: 'G', state: '공연예정', district: '전체', bookingLinks: [], detailImages: []
      );
      when(mockService.getPerformanceDetail('2')).thenAnswer((_) async => detail2);
    ...
    test('BookmarkListViewModel fetches details and removes expired', () async {
      ...
      final expiredDetail = PerformanceDetail(
        id: '1', title: 'T', startDate: '2020.01.01', endDate: '2020.01.01',
        venue: 'V', cast: 'C', runtime: 'R', timeGuidance: 'TG', ageLimit: 'A', price: 'P',
        posterUrl: 'P', genre: 'G', state: 'S', district: '전체', bookingLinks: [], detailImages: []
      );
      when(mockService.getPerformanceDetail('1')).thenAnswer((_) async => expiredDetail);
    ...
    test('BookmarkListViewModel returns valid details', () async {
      final validDetail = PerformanceDetail(
        id: '2', title: 'T', startDate: '2099.01.01', endDate: '2099.01.01',
        venue: 'V', cast: 'C', runtime: 'R', timeGuidance: 'TG', ageLimit: 'A', price: 'P',
        posterUrl: 'P', genre: 'G', state: '공연예정', district: '전체', bookingLinks: [], detailImages: []
      );
      when(mockService.getPerformanceDetail('2')).thenAnswer((_) async => validDetail);
    ...
    test('SearchViewModel searches with query, venue name, and genre', () async {
      final p1 = Performance(
        id: '1', title: 'Test Musical', startDate: '2023.01.01', endDate: '2023.01.01',
        venue: '울산문화예술회관', posterUrl: '', genre: '뮤지컬', state: 'S'
      , district: '전체');
      final p2 = Performance(
        id: '2', title: 'Test Play', startDate: '2023.01.02', endDate: '2023.01.02',
        venue: '중구문화의전당', posterUrl: '', genre: '연극', state: 'S'
      , district: '전체');
    ...
    test('DetailViewModel fetches single detail', () async {
      final detail = PerformanceDetail(
        id: '1', title: 'T', startDate: 'S', endDate: 'E', venue: 'V', cast: 'C',
        runtime: 'R', timeGuidance: 'TG', ageLimit: 'A', price: 'P', posterUrl: 'P', genre: 'G', state: 'S', district: '전체',
